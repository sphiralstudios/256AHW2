...
class Saw : public dsp {
  ...
  public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addNumEntry("freq", &fEntry0, 440.0f, 20.0f, 20000.0f, 0.00999999978f);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			float fTemp0 = max(1.00000001e-07f, fabsf(fRec2[0]));
			...
			output0[i] = FAUSTFLOAT(((((2.0f * fRec1) - 1.0f) * fRec3[0]) * fRec4[0]));
			fRec2[1] = fRec2[0];
			fRec0[1] = fRec0[0];
			fRec3[1] = fRec3[0];
			fRec4[1] = fRec4[0];
